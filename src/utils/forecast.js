...
const forecast = ((latitude, longitude, callback) => {
    ...
    request({url, json: true}, (error, {body}) => {
        if(error){
            ...
            callback(undefined,`It is currently ${body.currently.temperature} degrees out. There is ${body.currently.precipProbability*100}% chance of rain. Max: ${body.daily.data[0].temperatureHigh} and Min: ${body.daily.data[1].temperatureLow}`);
        }
    });
});
